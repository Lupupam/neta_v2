...
void NA_HackedModule::restartDetectionCounters() {
    LOG << "Class HackedModule: restartDetectionCounters\n";
}
void NA_HackedModule::handleMessageFromAttackController(cMessage *msg) {
    LOG << "Class HackedModule: HandleMessageFromAttackController\n";
}
void NA_HackedModule::handleMessageFromDetectionController(cMessage *msg, NA_Detector *controller) {
    LOG << "Class HackedModule: handleMessageFromDetectionController\n";
}
